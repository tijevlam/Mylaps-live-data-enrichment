...
client.connect(3389, '34.91.108.92', function() { //35.204.46.233
    ...
    let passingSE = "TimeSE@Passing@"
    data.forEach(d => {
        passingSE += `c=${d.c}|ct=${d.ct}|t=${d.t}|d=${d.d}|l=${d.l}|dv=${d.dv}|re=${d.re}|an=${d.an}|g=${d.g}|n=${d.n}|b=${d.b}@`
    })
    passingSE += "75@$"
    client.write(passingSE);
